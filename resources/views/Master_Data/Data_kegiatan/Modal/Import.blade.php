<div class="modal fade" id="modalImportKegiatan" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form id="formImportKegiatan" enctype="multipart/form-data">
                <div class="modal-header">
                    <h5 class="modal-title">Import Excel Kegiatan</h5>
                ...
                <div class="modal-body">
                    ...
                    <p class="text-muted small">
                        ...
                        <b>kode | nama | id_program</b><br>
                        <a href="{{ route('kegiatan.template') }}" class="btn btn-sm btn-outline-success mt-2">
