<div class="modal fade" id="modalImportAkun" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form id="formImportAkun" enctype="multipart/form-data">
                <div class="modal-header">
                    <h5 class="modal-title">Import Excel Akun Belanja</h5>
                ...
                <div class="modal-body">
                    ...
                    <p class="text-muted small">
                        📄 Format kolom Excel:
                        <b>kode | uraian</b><br>
                        <a href="{{ route('akun.template') }}" class="btn btn-sm btn-outline-success mt-2">
